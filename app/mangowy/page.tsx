    ...
    return(
        <div className="grid justify-items-center">
            <div className="mt-6 p-6 w-10/12 grid bg-neutral-800 rounded-xl">
                ...
                <div className="flex flex-row keen-slider mt-1 align-middle place-content-center items-center text-center">
                    <Link href='mangowy/magazyn' className='place-content-center flex flex-col w-1/4 m-2 p-3 hover:border-neutral-950 hover:shadow-lg hover:shadow-orange-900/10 border border-neutral-950 rounded-lg'>
                    ...
                    <Link href='mangowy/sklep' className='place-content-center flex flex-col w-1/4 m-2 p-3 hover:border-neutral-950 hover:shadow-lg hover:shadow-orange-900/10 border border-neutral-950 rounded-lg'>
