...
export default function Page() {
    ...
    //Sortowanie
    useEffect(() => {
        const sorted = [...magazynData].sort((a, b) => b.id - a.id);
        setSortedData(sorted);
    }, [magazynData]);
    const [sortConfig, setSortConfig] = useState<{ key: keyof typeof magazynData[0], direction: 'asc' | 'desc' } | null>(null);
    const [sortedData, setSortedData] = useState([...magazynData]); // zakładam, że `data` pochodzi z propsów lub fetcha
    const sortBy = (key: keyof typeof magazynData[0]) => {
                        ...
                        onChange={(e) => {
                            ...
                            switch (value) {
                                ...
                                case 'Data sprzedaży':
                                    ...
                                    break;
                                default:
                                    setSortedData([...magazynData]); // przy "Brak" resetujemy do oryginału
                                    setSortConfig(null);
                            }
                        }}
                    >
